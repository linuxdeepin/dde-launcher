 ...
 * Command line was: qdbusxml2cpp -c DBusStartManager -p dbustartmanager org.deepin.dde.Application1.Manager.xml
 *
...
DBusStartManager::DBusStartManager(QObject *parent)
    : QDBusAbstractInterface("org.deepin.dde.Application1.Manager", "/org/deepin/dde/Application1/Manager", staticInterfaceName(), QDBusConnection::sessionBus(), parent)
{
