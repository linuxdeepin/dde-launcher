...
QByteArray const DESKTOP_BACKGROUND_NAME("com.deepin.wrap.gnome.desktop.background");
QByteArray  const DESKTOP_BACKGROUND_ADDRESS("/com/deepin/wrap/gnome/desktop/background/");

SystemBackground::SystemBackground(QSize size, bool isBlur, QObject *parent):
    QObject(parent),
    m_backgroundSize(size),
    m_isBlur(isBlur),
    m_gsettings(new QGSettings(DESKTOP_BACKGROUND_NAME,
                              DESKTOP_BACKGROUND_ADDRESS, this))
{
