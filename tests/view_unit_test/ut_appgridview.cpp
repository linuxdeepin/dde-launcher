...
//    view.mousePressEvent(&leftMousePress);
...
//    view.mousePressEvent(&rightMousePress);
...
//    view.mouseReleaseEvent(&leftReleaseEvent);

//    QMouseEvent rightReleaseEvent(QEvent::MouseButtonRelease, QPointF(0, 0), QPointF(0, 1), QPointF(1, 1), Qt::RightButton, Qt::LeftButton, Qt::NoModifier);
//    view.mouseReleaseEvent(&rightReleaseEvent);
...
//    view.dragLeaveEvent(&categoryDragLeaveEvent);

//    view.dragOut(-1);
//    view.dragIn(QModelIndex());

//    view.prepareDropSwap();
//    //    view.createFakeAnimation(0, true, false);
//    view.dropSwap();
//}
